...
use crate::parser::generated::orca_whirlpools::types::RemainingAccountsInfo;
#[cfg(feature = "anchor")]
...
impl DecreaseLiquidityV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DecreaseLiquidityV2InstructionData::new()
            .try_to_vec()
            .unwrap();
        ...
        solana_program::instruction::Instruction {
            program_id: crate::ORCA_WHIRLPOOLS_ID,
            accounts,
            data,
        }
    }
