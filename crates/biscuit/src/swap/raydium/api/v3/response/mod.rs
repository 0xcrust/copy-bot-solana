...
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(transparent)]
pub struct ApiV3TokenInfo(Vec<Option<ApiV3Token>>);
...
pub struct ApiV3PoolsPage<T> {
    ...
    pub data: Vec<ApiV3BasePool<T>>,
}

pub type ApiV3StandardPool = _ApiV3StandardPool;
pub type ApiV3StandardPoolsPage = ApiV3PoolsPage<ApiV3StandardPool>;

pub type ApiV3ClmmPool = _ApiV3ClmmPool;
