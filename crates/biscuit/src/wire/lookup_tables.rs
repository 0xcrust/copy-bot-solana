...
impl AddressLookupTableStore {
    ...
    pub async fn resolve_addresses_from_lookup_table(
        &self,
    ...
    pub async fn reload_if_necessary(&self, alt_messages: &[&MessageAddressTableLookup]) {
...
//     fn resolve_addresses_from_lookup_table(
//         &self,
//         message_address_table_lookup: &MessageAddressTableLookup,
//     ) -> impl Future<Output = (Vec<Pubkey>, Vec<Pubkey>)>;

//     fn reload_if_necessary(
//         &self,
